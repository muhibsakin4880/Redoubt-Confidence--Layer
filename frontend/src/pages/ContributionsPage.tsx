...
export default function ContributionsPage() {
    ...
    const schemaFieldData = PROVIDER_UPLOAD_STEP3_SCHEMA_FIELDS
    ...
    const buildSchemaReviewSnapshot = (): ProviderDatasetSchemaReviewSnapshot => ({
        ...
        fieldSummaries: schemaFieldData.map(field => ({
            ...
            sample: field.sample,
            cryptoState: field.cryptoState,
            cardinality: field.cardinality,
            provenance: field.provenance,
            anomalyFlags: field.anomalyFlags,
            updateVelocity: field.updateVelocity
        })),
