...
export default function AdminLoginPage() {
    const { isAuthenticated, isAdmin, signInAdmin, signOut } = useAuth()
    ...
    const handleAuthenticate = (e: React.FormEvent) => {
        ...
        const success = signInAdmin(adminId, passphrase)
        ...
        return (
            <div className="min-h-screen bg-black flex items-center justify-center p-4">
                <div className="text-center space-y-4">
                    ...
                    <h1 className="text-xl font-mono font-bold text-red-400 uppercase tracking-wider">
                        Access Denied
                    </h1>
                    ...
                    <button
                        ...
                        className="text-sm font-mono text-slate-500 hover:text-slate-300"
                    >
